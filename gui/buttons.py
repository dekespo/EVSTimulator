...
class buttonGUI(tk.Frame):
    def __init__(self, parent):
        ...
        buttonFrame.grid(row = const.rowOrder, column = const.colOrder, sticky = const.sticky)
    ...
    def clickLeftButton(self):
        ...
        label = tk.Label(newWindow, text = "This is Left button, my dear friend")
        label.pack()

    def clickMiddleButton(self):
        newWindow = tk.Toplevel(self.parent)
        label = tk.Label(newWindow, text = "This is Middle button, my dear friend")
        label.pack()

    def clickRightButton(self):
        newWindow = tk.Toplevel(self.parent)
        label = tk.Label(newWindow, text = "This is Right button, my dear friend")
        label.pack()
